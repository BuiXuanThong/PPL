...
member_access_stmt: (SELF | exp) DOT ID LP exps_list? RP SEMI | ID SCOPE_OP DOLLAR_ID LP exps_list? RP SEMI;
...
callExp2: ID SCOPE_OP DOLLAR_ID  | ID SCOPE_OP DOLLAR_ID LP exps_list? RP | newExp; // dollar for static methods
